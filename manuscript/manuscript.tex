...
Materials Equation \ref{eq:vardecay}). Similarly, the loss in variation due to
fixation of weakly deleterious occurs on much slower timescales and can be
ignored here. Then, $\kappa_i = \nicefrac{V_{m,i}}{V_{a,i}}$ (see Supplementary
Materials Equation \ref{eq:Z}). 
...
studies \parencite{McVicker2009-ax,Elyashiv2016-vt,Murphy2022-sj} (note that
\cite{Santiago1998-bs} have shown a similar correspondence between their work
and BGS models with recombination from \cite{Nordborg1996-nq} and
\cite{Hudson1995-xc}).
...
$V_m = Us$, thus under a general equilibrium negative selection process,
...
variation, not additive genetic fitness variation. Intuitively, the equilibrium
genic fitness variation is a balance between the rate of gain of genic fitness
variation due to mutation and its loss due to fixation. Note that since
mutation is the ultimate source of all mutations that fix or are lost, $U \ge
R$.
