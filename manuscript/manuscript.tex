...
However, when selection is weak and fitness is polygenic, the stochasticity
introduced by draft can be approximated by assuming draft just increases the
rate of drift. This is often expressed as rescaling the effective population
size

Though there are subtle differences in the effective population sizes

rescaling the
drift-effective population size by an appropriate factor
