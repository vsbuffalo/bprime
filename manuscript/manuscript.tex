...
Since our $R_\text{LOCO}^2$ estimates suggest our models fit left-out
...
Still, we find that our out-sample $R_\text{LOCO}^2$ for the Yoruba samples
($R_\text{LOCO}^2 \approx 68$\%) is close to the theoretic $R_\text{coal}^2
\approx 67$\%. For bottlenecked out-of-Africa populations, $R_\text{coal}^2
\approx 64$\% compared to the observed $R_\text{LOCO}^2 \approx 62$\% for CEU
and $R_\text{LOCO}^2 \approx 59$\% for CHB. We note that because bottlenecks
increase the variance in coalescence times beyond the level implied by the
effective population size, the disagreement between observed $R_\text{LOCO}^2$
...
Linked selection theory suggests the reduction signal is proportional to the
