...
Materials Figure \ref{suppfig:rescale}). However, this is not the case when the
locally-rescaled maximum likelihood estimates are used to predict on the
non-locally-rescaled B' maps.
