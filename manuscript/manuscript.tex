...
\textcite{Cvijovic2018-vd}). First, when selection is strong, the number of
deleterious mutations per haplotype has a stationary Poisson distribution with
mean equal to the equilibrium under the deterministic mutation-selection model
\parencite{Haldane1927-ga}. Since lineages carrying any strongly deleterious
mutations cannot contribute to the genealogy, coalescence events only occur in
the fraction $\exp(-\nicefrac{U}{s}$ free of mutations. Second, two present-day
lineages carrying any deleterious mutations trace their ancestry back to the
pool of $N_0$ mutation-free ancestors very quickly, since these harmful
mutations could only have been acquired recently by the lineage. On coalescence
timescales of $\sim 2N_0$, this time is negligible and can be ignored
(\textcite{Durrett2008-ql}, p. 213; \textcite{Good2014-yz}). 
