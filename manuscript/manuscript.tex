...
\begin{align}
  \label{eq:}
  {N}_{e}(x) &= \exp \left( -\frac{V(x)}{2} Q^2(x) \right) & \text{\emph{effective population equation}} \\
  {R}(x) &= \frac{4NU s}{\exp(4 N s)-1}  & \text{\emph{ratchet equation}} 
\end{align}

where,

\begin{align}
  V(x) &= U s - 2 {R}(x) s & \text{\emph{variation equation}} \\
  Q^2(x) &= \frac{2}{(1-Z)(2-(2-M)Z)} & \text{\emph{linkage persistence factor}} \\
