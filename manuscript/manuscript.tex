...
where $L = n r_\text{BP}$ is the total segment length in Morgans. Let us define
the total asymptotic effect of associations from all sites as $Q_\infty^2$.
Then,

\begin{align}
  Q_\infty^2 &= \frac{2}{L}\int_0^{\nicefrac{n r_\text{BP}}{2}} Q_{\infty}(x)^2 dx  \\
  &=  \frac{2}{L} \int_0^{\nicefrac{L}{2}} \left(\frac{1}{1 - (1-x)Z}\right)^2 dx  \\
  &= \frac{2}{(1-Z) (2-(2-L) Z)}
\end{align}
