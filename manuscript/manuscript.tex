...
\begin{abstract}
    ...
    Previous work has shown that negative selection against the steady influx
    of deleterious mutations is the predominant process shaping genome-wide
    patterns of genetic diversity in humans. This process leaves a ``linked
    selection signal" 

    The classic population genetic
    model of this process, background selection, considers 

    % TODO: emphasize connection to nearly neutral theory

    % uniting quant gen/fitness variation, linked selection, and substitution
    % The interesting thing about connecting all these models is that we might
    % have hope of calibrating these models to the true process.
\end{abstract}
