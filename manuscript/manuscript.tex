...
autocorrelation, the cumulative effect of this fitness variance is inflated 
...
We can define the draft-effective population size $N_d$ by including the total
...
the human lineage (Figure \ref{fig:figure-7}). As expected, the predicted
