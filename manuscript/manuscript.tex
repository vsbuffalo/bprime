...
When mutations are weakly deleterious, their frequency trajectories are no
longer well-approximated by deterministic models. This is because the selection
on an allele is only weak relative to the scale of stochastic perturbations it
encounters along its trajectory. When genetic drift is the only source of
randomness in allele frequency change, the relevant scale of stochastic
perturbations is the drift-effective population size $N$ and selection dynamics
are governed by compound parameter $2Ns$. When $2Ns \gg 1$, the stochastic
component of allele frequency change is minuscule relative to selection and can
be ignored as the classic BGS theory does; this is why the rescaling factor
under the BGS model does not depend on $N$. However, when $2Ns \le 1$
stochastic perturbations are large relative to selection, and a weakly
deleterious allele can drift up to intermediate frequencies before eventual
loss or fixation. Weakly deleterious alleles can persist in the population much
longer, and consequently 

When this occurs, the distribution of the number of deleterious mutations (and
its corresponding fitness distribution) are no longer stationary and become a
traveling wave \parencite{Rouzine2008-qz,Good2013-lp}. Furthermore, individuals
in the least-loaded class are stochastically lost, fixing those mutations with
a click of ``Muller's ratchet" \parencite{Muller1964-ki}. Determining both the
rate of Muller's ratchet \parencite{Haigh1978-gt,Gordo2002-dr,Gessler1995-hz}
and the shape of genealogies under weak selection
\parencite{Przeworski1999-mb,OFallon2010-my,Higgs1995-xc} have been stubborn
problems 
