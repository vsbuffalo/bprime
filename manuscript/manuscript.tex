...
However, there was no similar consistent change in mutation rate estimates
among populations. Overall, this suggests that the linked selection signal
alone carries little information that can differentiate very strong selection
from a slightly smaller drift-effective population size.
...
The PhastCons class of this Feature Priority model, which contains non-coding
highly conserved elements (XXX), is under strong selective constraint as
expected. 
