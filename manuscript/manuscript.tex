...
probability is given by $\bar{\pi}(b; \Psi) = \pi_0 \bar{B}(b; \mu,
\mathbf{W})$, where bars indicate averages over some bin width, and the
reduction is
...
features. See Supplementary Materials Sections \ref{supp:data-summary} and
