...
\subsection{Sources of Neutral Allele Frequency Change}
...
\begin{align}
  ...
  \frac{\V(x_2 - p_0)}{p_0(1-p_0)} &= \frac{V_A}{2N} + \frac{V_A Q_2^2}{2N}\left(1-\frac{1}{2N}\right)  +  \frac{V_A}{2N_}  \left(1-\frac{1}{2N}\right)  \nonumber \\ 
...
\emph{draft-effective} population size analogous to Supplementary Equation
\eqref{supp-eq:var-ne}. In an ideal Wright--Fisher population, the
instantaneous variance is $\V(\Delta x_t) =
...
We now turn to different expressions for $Q_t^2$ and $V_A$.
...
segment. The implementation of our method differs slightly on though, see XXX.
...
\subsection{The Draft-Effective Population Size Under Weak and Strong BGS}
...
Supplementary Materials Equation \ref{supp-eq:Va} above can also be found
