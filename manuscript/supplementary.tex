...
giving us $\widetilde{V}$ and $\widetilde{Q}_\infty^2$ for each set of
parameters. Then, 

\begin{align} 
    b'(\mu, s, L, r, d) = -\frac{\widetilde{V}}{2} \left(\frac{1}{(1-(1-d)Z}\right)^2 
\end{align}
%
where $Z = 1 - Us / (U-\widetilde{R})$ and $\widetilde{V} = Us - 2\widetilde{R}s$. As
