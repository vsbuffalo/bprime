...
\caption{$R^2$ and mutation rate estimates for all primary models fit on the
    default DFE grid (up to selection $s=10^{-1}$).}
...
PhastCons Priority &              full &          CHB &                        58.76 &             60.45 &            52.93 &                                 1.8689 &                                0.1101 \\
  ...
  Feature Priority &              full &          CHB &                        55.63 &             57.88 &            51.39 &
\end{tabular}
\end{table}
...
\centering
\caption{$R^2$ and mutation rate estimates for all primary models fit 
    with the strong selection grid (up to $s=10^{-1}$). Note that the repeated values in the last rows are
    correct and due to rounding; see \path{notebooks/main_fits.ipynb} in the
