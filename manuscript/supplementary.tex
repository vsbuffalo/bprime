...
\caption{$R^2$ and mutation rate estimates for all primary models fit with the
    ...
    \path{notebooks/main_fits.ipynb} in the GitHub repository for more
...
\begin{figure}[htbp]
  ...
  $\mu = 1.6 \times 10^{-8}$ and three different selection coefficients. For
$s=10^{-5}$ ($2N_e s = 0.2$), locally-rescaling alters the predicted reduction
so that it is essentially insignificant ($B \approx 1$). }
