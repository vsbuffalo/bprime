...
appropriately scaled. We use the predicted $\hat{B}_i$ as the plugin estimator
for $B_i$. Then, we note that the variance in pairwise diversity is equivalent
to the variance in the number of segregating sites for a sample of two,
$\var(\pi) = \var(S_2)$. From \textcite[eq. 7.20]{Wakeley2009-ua}
...
mutation rates, $\nicefrac{r}{\mu}$. In humans, $\gamma \approx 1$, but explore
different ratios to assess sensitivity of this calculation (Supplementary
Figure \ref{suppfig:r2_upper}). 
