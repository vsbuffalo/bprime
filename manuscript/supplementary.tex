...
63.66\% of the autosomal reference sequence.
...
10^{-71}$) in the CADD 70\% neutral track. However, we did not use the CADD
70\%  neutral track in our analysis of human population genomic data. Our
concern was that this neutral track would be too close to the complement of the
CADD 6\% track, which we use as one of our annotation models.
